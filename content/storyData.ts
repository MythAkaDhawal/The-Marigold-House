...
export const STORY_CONTENT = {
  ...
  smallMoments: {
    ...
    keepsakes: [
      ...
      },
      {
        ...
        date: 'February 14',
        type: 'photo',
        summary: 'Dusk at the overlook',
        detail: 'The light was turning deep saffron. Your hair was slightly windswept, and for a second you looked directly at the lens with a quiet, knowing smile that made time pause.',
        rotationDeg: -0.8,
      },
    ] as KeepsakeItem[],
  },
  letter: {
    ...
    salutation: 'My Love,',
    bodyParagraphs: [
      'If I have learned anything in our time together, it is that love is not an event that happens once and stays finished. It is a slow, daily practice of choosing to notice.',
      'I notice the way you carry light into a dark room without trying. I notice the way you listen when someone is soft-spoken. I notice how you make ordinary Tuesdays feel like homecoming.',
      'I built this quiet corner of the digital world for you — not to show off, but because some feelings deserve a space where nothing else is allowed to compete for your attention.',
      'Every word here was written because you exist, and because my life became immeasurably warmer the day you walked into it.',
      'I carry you in every unhurried thought. Always.',
    ],
    closing: 'Yours in all hours,',
